...
export function CreateTaskForm() {
  ...
  // ✅ O useState precisa ficar dentro do componente!
  ...
  const {
    ...
    isPending,
    isError,
  } = useMutation<unknown, AxiosError, CreateNewTaskProps>({
    ...
    onError: error => {
      ...
      // ✅ Usa null como fallback para evitar undefined
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
          ...
          {isError && errorMessage && (
            <p className='text-[0.8rem] font-medium text-red-500'>
              {errorMessage || 'Erro ao criar nova tarefa'}
            </p>
          )}
        </form>
      </FormProvider>
